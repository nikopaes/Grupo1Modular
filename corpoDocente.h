...
*       -A cadeia de caracteres bairro é válida
*		-A cadeia de caracteres rua é válida	
*		-O inteiro numero é válida
*		-A cadeia de caracteres complemento é válida
* 
*  Assertiva de Saída: 
