...
/***********************************************************************
*
*  $TC Tipo de dados: LIS Tipos de Dados
*
*
...
***********************************************************************/
	typedef enum {
         LIS_IdCabecaLista , /* Id do tipo cabeça de lista */
         LIS_IdNoLista , /* Id do tipo nó de lista */
         LIS_IdString ,  /* Id do tipo string */
         LIS_IdTipoNaoDefinido /* Id de uma lista que nao possui um tipo definido ainda */   
	} LIS_idTipo ;
