   ...
   TST_tpCondRet TST_EfetuarComando(char * ComandoTeste){
      ...
      /* Testar PRF Criar professor */
         ...
         if ( strcmp( ComandoTeste , CRIAR_CMD ) == 0 )
         {
			...
			CondRetObtido = criaProf( p+index, paramMatricula, paramCPF, paramPais, paramDia, paramMes, paramAno ) ;			
         ...
         else if ( strcmp( ComandoTeste , MOSTRAR_CMD ) == 0 )
         {
            ...
            CondRetObtido = mostraProf(p[index]);
      ...
      /* Testar PRF liberar professor */
         ...
         else if ( strcmp( ComandoTeste , LIBERAR_CMD ) == 0 )
         {
            ...
            CondRetObtido = liberaProf(p+index) ;
...
//------------------------------------------Consultas----------------------------------
		 ...
		 else if ( strcmp( ComandoTeste , CONSULTA_CPF_CMD ) == 0 )
         {
            ...
            CondRetObtido = consultaCpfProf(p[index], valorStringObtido) ;
		 ...
		 else if ( strcmp( ComandoTeste , CONSULTA_PAIS_CMD ) == 0 )
         {
            ...
            CondRetObtido = consultaPaisProf(p[index], valorStringObtido) ;
		 ...
		 else if ( strcmp( ComandoTeste , CONSULTA_MATRICULA_CMD ) == 0 )
         {
            ...
            CondRetObtido = consultaMatriculaProf(p[index], &valorObtido) ;
...
// ----------------------------------------Alteras-------------------------------
      ...
      /* Testar PRF alterar cpf */
         ...
         else if ( strcmp( ComandoTeste , ALTERA_CPF_CMD ) == 0 )
         {
            ...
            CondRetObtido = alteraCpfProf(p[index],  paramCPF ) ;
         ...
         else if ( strcmp( ComandoTeste , ALTERA_PAIS_CMD ) == 0 )
         {
            ...
            CondRetObtido = alteraPaisProf(p[index],  paramPais ) ;
         ...
         else if ( strcmp( ComandoTeste , ALTERA_MATRICULA_CMD ) == 0 )
         {
            ...
            CondRetObtido = alteraMatriculaProf(p[index],  paramMatricula ) ;
